	...
	<div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
		<div>
			...
			>
				<li class="flow-root">
					<div
						class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-red-400 hover:bg-gray-50"
					>
						<div
							class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-lg bg-teal-500"
						>
							<svg
				...
				<li class="flow-root">
					...
					>
						...
						<div>
							...
							<p class="mt-1 text-sm text-gray-500">
								Update the available chinchillas for adoption.
							</p>
						</div>
					</div>
				</li>
				...
				<li class="flow-root">
					...
					>
						<div
							class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-lg bg-red-500"
						>
							<svg
								class="h-6 w-6 text-white"
								fill="none"
						...
						<div>
							<h3 class="text-sm font-medium text-gray-900">
								<a href="#" class="focus:outline-none">
									<span class="absolute inset-0" aria-hidden="true" />
									<span> View Shop Orders </span>
									<span aria-hidden="true"> &rarr;</span>
								</a>
							</h3>
							<p class="mt-1 text-sm text-gray-500">Review orders placed in the shop.</p>
						</div>
					</div>
				</li>
				<li class="flow-root">
